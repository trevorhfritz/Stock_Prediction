...
# The 10 features the model was trained on:
# TextBlob sentiment scores for 9 non-AAPL tickers + AAPL's own sentiment_textblob
FEATURE_KEYS = ['ADBE', 'AMZN', 'FB', 'GOOG', 'JPM', 'MSFT', 'NFLX', 'TSLA', 'WMT', 'sentiment_textblob']
 
FEATURE_LABELS = {
    'ADBE': 'ADBE Sentiment (TextBlob)',
    'AMZN': 'AMZN Sentiment (TextBlob)',
    'FB':   'FB Sentiment (TextBlob)',
    'GOOG': 'GOOG Sentiment (TextBlob)',
    'JPM':  'JPM Sentiment (TextBlob)',
    'MSFT': 'MSFT Sentiment (TextBlob)',
    'NFLX': 'NFLX Sentiment (TextBlob)',
    'TSLA': 'TSLA Sentiment (TextBlob)',
    'WMT':  'WMT Sentiment (TextBlob)',
    'sentiment_textblob': 'AAPL Sentiment (TextBlob)',
}
...
MODEL_INFO = {
        ...
        "keys": FEATURE_KEYS,
        "inputs": [{"name": k, "label": FEATURE_LABELS[k], "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in FEATURE_KEYS]
}
